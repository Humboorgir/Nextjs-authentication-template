  ...
  ({ className, type, placeholder, ...props }, ref) => {
    return (
      <div className={cn("relative h-fit w-fit", className)}>
        <input
          type={type}
          className="bg-background ring-offset-background border-ring focus:ring-offset-3 focus:border focus:border-primary text-foreground peer bottom-0 left-0 right-0 top-0 flex w-full rounded-md border px-3 py-2.5 transition-[border] placeholder:text-transparent focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
